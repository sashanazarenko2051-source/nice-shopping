(function() {
  ...
  var T = {
    ua: {
      ...
      'how.s2t': "Зв'яжіться з нами", 'how.s2p': 'Напишіть у Telegram @NazarT85 або зателефонуйте Тетяні',
      ...
      'pd.add': 'Додати до кошика', 'pd.desc': 'Опис', 'pd.specs': 'Характеристики',
      'pd.reviews_word': 'відгуків', 'pd.select_size': 'Оберіть розмір',
      'quick.add': 'Швидко додати',
      ...
      'cart.cont': '← Продовжити покупки', 'cart.summ': 'Підсумок замовлення', 'cart.remove': 'Видалити',
      ...
      'co.del': 'Доставка',
      'co.del.nova': '🟡 Нова Пошта', 'co.del.nova.d': 'Доставка по всій Україні',
      'co.del.ukr': '🔵 Укрпошта',
      'co.city': 'Місто *', 'co.city.ph': 'Київ',
      'co.branch.nova': 'Відділення або адреса доставки *', 'co.branch.nova.ph': 'Відділення №1 або вул. Хрещатик, 1',
      'co.branch.ukr': 'Поштовий індекс або відділення *', 'co.branch.ukr.ph': 'Індекс 01001 або відділення №5',
      'co.comment': 'Коментар до замовлення', 'co.comment.ph': 'Побажання, уточнення...',
      'co.payment': 'Оплата',
    ...
    en: {
      ...
      'how.s2t': 'Contact us', 'how.s2p': 'Message us on Telegram @NazarT85 or call Tetyana',
      ...
      'pd.add': 'Add to cart', 'pd.desc': 'Description', 'pd.specs': 'Specifications',
      'pd.reviews_word': 'reviews', 'pd.select_size': 'Please select a size',
      'quick.add': 'Quick add',
      ...
      'cart.cont': '← Continue shopping', 'cart.summ': 'Order summary', 'cart.remove': 'Remove',
      ...
      'co.del': 'Delivery',
      'co.del.nova': '🟡 Nova Poshta', 'co.del.nova.d': 'Delivery across Ukraine',
      'co.del.ukr': '🔵 Ukrposhta',
      'co.city': 'City *', 'co.city.ph': 'Kyiv',
      'co.branch.nova': 'Branch or delivery address *', 'co.branch.nova.ph': 'Branch No.1 or st. Khreshchatyk, 1',
      'co.branch.ukr': 'Postal code or branch *', 'co.branch.ukr.ph': 'Index 01001 or branch No.5',
      'co.comment': 'Order comment', 'co.comment.ph': 'Wishes, clarifications...',
      'co.payment': 'Payment',

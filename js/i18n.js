(function() {
  ...
  var T = {
    ua: {
      ...
      'nav.home': 'Головна', 'nav.cart': 'Кошик',
      ...
      'footer.rights': 'Усі права захищені', 'footer.copy': '© 2025 Файні покупки',
      'footer.wl': 'Жіноча білизна', 'footer.ml': 'Чоловіча білизна',
      'bc.home': 'Головна', 'bc.catalog': 'Каталог', 'bc.contacts': 'Контакти',
      'bc.cart': 'Кошик', 'bc.checkout': 'Оформлення',
      'page.catalog': 'Каталог', 'page.contacts': 'Контакти',
      'page.cart': 'Кошик', 'page.checkout': 'Оформлення замовлення',
    ...
    en: {
      ...
      'bc.cart': 'Cart', 'bc.checkout': 'Checkout',
      'page.catalog': 'Catalog', 'page.contacts': 'Contacts',
      'page.cart': 'Cart', 'page.checkout': 'Checkout',
